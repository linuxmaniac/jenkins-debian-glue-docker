# Jenkins-Debian-Glue Docker image

The Jenkins Continuous Integration and Delivery server + jenkins-debian-glue

Based on <a href="https://github.com/cloudbees/jenkins-ci.org-docker">Official Jenkins Docker image</a>
